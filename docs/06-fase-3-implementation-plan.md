...
| 3.2 | **Upload thumbnail** | File upload ke PocketBase | ⬜ |
...
| 4.2 | **Update thumbnail** | Upload ulang | ⬜ |
...
| 5.2 | **Reorder sections** — Drag & drop atau tombol naik/turun | Update sort_order | ⬜ |
| 5.3 | **List lectures per section** — Expandable | Fetch lectures by section | ⬜ |
| 5.4 | **Tambah lecture** — Modal/form pilih tipe (video/article/resource) | CRUD lectures | ⬜ |
| 5.5 | **Edit lecture** — Edit judul, URL, konten, dll | Pre-filled form | ⬜ |
...
| 🆕 Create Course | 7 |
| ✏️ Edit Course | 4 |
| 📚 Curriculum Builder | 8 |
| 📢 Announcements | 3 |
| 👥 Student List | 2 |
| 🏷️ Coupon Management | 4 |
| 🧪 Testing | 6 |
| **Total** | **42** |
